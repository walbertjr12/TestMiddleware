...
namespace SmartAdminMvc
{
    public static class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //bundles.Add(new StyleBundle("~/content/smartadmin").Include("~/content/jquery.timepicker.css"));
            ...
            bundles.Add(new ScriptBundle("~/scripts/charts").Include(
                ...
                "~/scripts/plugin/chartjs/Chart.bundle.min.js",
                "~/scripts/plugin/chartjs/chartjs-plugin-labels.min.js",
                "~/scripts/plugin/dropzone/dropzone.min.js"
                ));
            ...
            bundles.Add(new ScriptBundle("~/scripts/datatables").Include(
                ...
                "~/scripts/plugin/datatables/buttons.flash.min.js",
                "~/scripts/plugin/datatables/jszip.min.js",
                "~/scripts/plugin/datatables/pdfmake.min.js",
                "~/scripts/plugin/datatables/vfs_fonts.js",
                "~/scripts/plugin/datatables/buttons.html5.min.js",
                "~/scripts/plugin/datatables/buttons.print.min.js"
                ));
